...
public class LevelOne : MonoBehaviour 
{
	...
	void Start () 
	{
		Objective = "Faça 15 pontos em 40 segundos."; // Valor da Variavel Missao
	...
	{
		// Missao 1
		if (RandomBalls.Score == 15 && time < 40) // Verifica a missao e defini se o player cumpriu a missao;
		{
			Win = true; // Player Venceu;
		}
		if (RandomBalls.Score < 15 && time > 40) // Verifica a missao e defini se o player nao cumpriu a missao;
		{
