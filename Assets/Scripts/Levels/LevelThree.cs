...
public class LevelThree : MonoBehaviour 
{
	...
	void Start () 
	{
		Objective = "Faça 10 pontos em 30 segundos."; // Valor da Variavel Missao
	...
	void mission ()
	{
		if (RandomBalls.Score == 10 && time < 30) // Verifica a missao e defini se o player cumpriu a missao;
		{
			Win = true; // Player Venceu;
		}
		if (RandomBalls.Score < 10 && time > 30) // Verifica a missao e defini se o player nao cumpriu a missao;
		{
