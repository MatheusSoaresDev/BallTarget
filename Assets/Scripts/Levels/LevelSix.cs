...
public class LevelSix : MonoBehaviour 
{
	...
	void Start () 
	{
		Objective = "Faça 10 pontos em 25 segundos"; // Valor da Variavel Missao
	...
	void mission ()
	{
		if (RandomBalls.Score == 10 && time < 25) // Verifica a missao e defini se o player cumpriu a missao;
		{
			Win = true; // Player Venceu;
		}
		if (RandomBalls.Score < 10 && time > 25) // Verifica a missao e defini se o player nao cumpriu a missao;
		{
