...
public class LevelEight : MonoBehaviour 
{
	...
	void Start () 
	{
		Objective = "Faça 60 pontos em 120 segundos"; // Valor da Variavel Missao
	...
	void mission ()
	{
		if (RandomBalls.Score == 60 && time < 120) // Verifica a missao e defini se o player cumpriu a missao;
		{
			Win = true; // Player Venceu;
		}
		if (RandomBalls.Score < 60 && time > 120) // Verifica a missao e defini se o player nao cumpriu a missao;
		{
