...
public class LevelFive : MonoBehaviour 
{
	...
	void Start () 
	{
		Objective = "Faça 30 pontos em 75 segundos."; // Valor da Variavel Missao
	...
	void mission ()
	{
		if (RandomBalls.Score == 30 && time < 75) // Verifica a missao e defini se o player cumpriu a missao;
		{
			Win = true; // Player Venceu;
		}
		if (RandomBalls.Score < 30 && time > 75) // Verifica a missao e defini se o player nao cumpriu a missao;
		{
