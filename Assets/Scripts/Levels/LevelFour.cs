...
public class LevelFour : MonoBehaviour 
{
	...
	public GUIStyle DefaultStyle; //Variavel para formataçao de texto;
	...
	void Start () 
	{
		Objective = "Faça 50 pontos em 200 segundos."; // Valor da Variavel Missao
	...
	{
		//Missao 4
		if (RandomBalls.Score == 50 && time < 200) // Verifica a missao e defini se o player cumpriu a missao;
		{
			Win = true; // Player Venceu;
		}
		if (RandomBalls.Score < 50 && time > 200) // Verifica a missao e defini se o player nao cumpriu a missao;
		{
