...
public class LevelTwo : MonoBehaviour 
{
	...
	void Start () 
	{
		Objective = "Faça 20 pontos em 50 segundos."; // Valor da Variavel Missao
	...
	void mission ()
	{
		if (RandomBalls.Score == 20 && time < 50) // Verifica a missao e defini se o player cumpriu a missao;
		{
			Win = true; // Player Venceu;
		}
		if (RandomBalls.Score < 20 && time > 50) // Verifica a missao e defini se o player nao cumpriu a missao;
		{
