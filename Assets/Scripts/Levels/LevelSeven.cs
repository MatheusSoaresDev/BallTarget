...
public class LevelSeven : MonoBehaviour 
{
	...
	void Start () 
	{
		Objective = "Faça 40 pontos em 160 segundos"; // Valor da Variavel Missao
	...
	void mission ()
	{
		if (RandomBalls.Score == 40 && time < 160) // Verifica a missao e defini se o player cumpriu a missao;
		{
			Win = true; // Player Venceu;
		}
		if (RandomBalls.Score < 40 && time > 160) // Verifica a missao e defini se o player nao cumpriu a missao;
		{
